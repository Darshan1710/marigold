<!DOCTYPE html>
	...
	<head>
	  ...
	  <body data-spy="scroll" data-target=".navbar" data-offset="70" class="thank_you">
	    ...
	    <div id="loader-wrapper">
	     ...
	     <section class="section_review thank_you_review">
	      <div class="container">
	        <div class="row">
	          <div class="col-sm-12">
	          	<div class="navbar-header">
		          <a class="navbar-brand pull-left" href="<?php echo base_url()?>"><?php echo TITLE; ?></a>
		          <a class="navbar-brand pull-right" href="<?php echo base_url()?>">Back</a>
		        </div>
	          ...
	          <div class="col-sm-12 text-center">
	            ...
	            <h2 class="section_review_title">Thanks For your valuable feedback. See you soon...</h2>
	          </div>
	        </div> <!-- .row -->
	      </div> <!-- .container -->
	    </section>
